...
public class ValidationItemControllerV2 {
    ...
    public String addItemV1(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 100_0000) {
            bindingResult.addError(new FieldError("item", "price",
                    "가격은 1,000 ~ 1,000,000원 까지 허용")
            );
        }
    ...
    public String addItemV2(@ModelAttribute Item item, BindingResult bindingResult,
        ...
        if (!StringUtils.hasText(item.getItemName())) {
            bindingResult.addError(new FieldError("item", "itemName", item.getItemName(),
                    false, null, null, "상품 이름은 필수")
            );
        }
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 100_0000) {
            bindingResult.addError(new FieldError("item", "price", item.getPrice(),
                    false, null, null, "가격은 1,000 ~ 1,000,000원 까지 허용")
            );
        }
        if (item.getQuantity() == null || item.getQuantity() > 9999) {
            bindingResult.addError(new FieldError("item", "quantity", item.getQuantity(),
                    false, null, null, "수량은 최대 9,999개까지 허용")
            );
        }
...
//        }
        ...
        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() > 100_0000) {
            bindingResult.rejectValue("price", "range", new Object[]{1000, 100_0000}, null);
        }
        if (item.getQuantity() == null || item.getQuantity() > 9999) {
